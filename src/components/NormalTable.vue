<template>
  <div class="table-container" :style="{ height: normalHeight }">
    ...
    >
      ...
      <!-- 垂直列-第一列为表头 -->
      <el-table-column v-if="vertical" width="150px">
          ...
          <div v-for="(col, index) in columns" :key="index">
            <div v-if="col.showInList && !col.hidden">
              ...
              <div v-if="col.handlerList">
                <span
                  class="handbtn"
                  v-for="(actionItem, hIndex) in col.handlerList"
                  @click="handlerClick(actionItem, scope)"
                  :key="hIndex"
                >
                  {{ actionItem.text }}
                </span>
